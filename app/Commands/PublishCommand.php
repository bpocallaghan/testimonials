...
namespace Bpocallaghan\Testimonials\Commands;
...
class PublishCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'testimonials:publish';
    ...
    private function copyModels()
    {
        ...
        // copy files
        $search = "namespace Bpocallaghan\Testimonials\Models;";
    ...
    private function copyViews()
    {
        ...
        $destination = resource_path('views\admin\testimonials');
        $this->copyFilesFromSource($source, $destination);

        // WEBSITE
        $source = $this->basePath . "resources\\views\website";
        $destination = resource_path('views\website\testimonials');
        $this->copyFilesFromSource($source, $destination);
    }
    ...
    private function copyControllers()
    {
        ...
        $destination = app_path('Http\Controllers\Admin\Testimonials');

        // copy files
        $search = ["testimonials::", "Bpocallaghan\Testimonials\Models", "namespace Bpocallaghan\Testimonials\Controllers\Admin;"];
        $replace = ["testimonials.", "App\Models", "namespace App\Http\Controllers\Admin\Testimonials;"];
        $this->copyFilesFromSource($source, $destination, $search, $replace);
        ...
        // replace files
        $search = ["testimonials::", "Bpocallaghan\Testimonials\Models", "namespace Bpocallaghan\Testimonials\Controllers\Website;"];
        $replace = ["testimonials.", "App\Models", "namespace App\Http\Controllers\Website;"];
        $this->copyFilesFromSource($source, $destination, $search, $replace);
    }
    ...
    private function copyDatabase()
    {
        ...
        $search = "namespace Bpocallaghan\Testimonials\Seeds;";
        ...
        $search = "namespace Bpocallaghan\Testimonials\Migrations;";
        $this->copyFilesFromSource($source, $destination, $search);
    }
